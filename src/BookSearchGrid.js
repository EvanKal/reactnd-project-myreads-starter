...
class BookSearchGrid extends React.Component {
  ...
  componentDidUpdate(prevProps, prevState) {
    if (
      this.props.queryToRequest &&
      this.props.queryToRequest !== prevProps.queryToRequest
    ) {
      BooksAPI.search(this.props.queryToRequest).then(allBooksInSearch => {
